    ...
    >
      ...
      <div className="main-content">
        <Container maxWidth="md">
          ...
          {project.mockup === "" ? null : <Mockup project={project}></Mockup>}
          {project.myWork.length === 0 ? null : (
            <MyWorkSection project={project}></MyWorkSection>
          )}
          <ul className="project-links">
            <li>
              {project.demo == null ? null : (
                <Button
                  sx={classes.demoButton}
                  variant="contained"
                  color="success"
                  target="_blank"
            ...
            <li>
              {
                project.thesis == null ? null : (
                  <Button
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    href={"/portfolio/project-media/dokus/" + project.thesis}
                  >
                    zur Thesis
                  </Button>
                ) /* /portfolio/assets */
            ...
            <li>
              {
                project.docu === "" ? null : (
                  <Button
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    href={"/portfolio/project-media/dokus/" + project.docu}
                  >
                    zur Dokumentation
                  </Button>
                ) /* /portfolio/assets */
            ...
            <li>
              {project.docu2 === "" ? null : (
                <Button
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href={"/portfolio/project-media/dokus/" + project.docu2}
                >
                  zur HoloCubes Dokumentation
                </Button>
              )}
            </li>
          </ul>
