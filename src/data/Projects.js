    ...
    const projects = [
        {
            ...
            technologies: [
                ...
                "Partzipative Entwicklung",
                "Webentwicklung mit Phaser"
            ],
            image: "BA/BAPreview.png",
            about: [
                "Dieses Projekt stellt meine Bachelorarbeit am Ende meines Studiums dar.",
                "In diesem Projekt bin ich zum ersten Mal im Studium mit wissenschaftlichem Arbeiten näher in Berührung gekommen, habe ein Thema entwickelt und Forschungsfragen beantwortet.",
                "Das entstandene Projekt ist im Rahmen des Forschungsprojektes 'Pflegeschätze' entwickelt worden und war ein UX Studie zur Nutzung von Gamification-basierten Ansätzen in Workshops mit Eltern von pflegebedürftigen Kindern.",
                "",
                "Die folgenden Bildern zeigen Einblick in den Prozess und das Video zeigt einen Ausschnitt des entstandenen Prototyps:"
            ],
            hasGallery: true,
            mockup: "BA/LiveDemo_Backup.mp4",
            mockupVorschau: "BA/HerausforderungenPräsentieren.png",
            mockupDescription: "Eine kurze Live-Demo des Prototyps",
            myWork: [
                "Ich habe das Teilprojekt alleine bearbeitet, doch die Unterstützung durch Informationen, Feedback und die Kontakte zu relevanten Expertengruppen innerhalb des Projektes waren sehr hilfreich.",
                "",
                "Für einen tieferen Einblick, führt der folgende Button zu der abgegebenen Arbeit:"
            ],
            path: "https://github.com/moumitahmad/ba-game",
            thesis: "MoumitaAhmad_Bachelorarbeit.pdf"
        },
        {
            id: 1,
            title: "FamilyTree",
            ...
            about: [
                ...
                "Dieses Projekt ist in meinem sechsten Semester entstanden und diente dazu C++ etwas besser kennenzulernen.",
                "Umgesetzt wurde die Idee in Qt mit einer SQLite Datenbank.",
                <br />,
                "Die folgenden Bilder zeigen Ausschnitte in die Konzeptionsphase und das entstandene Produkt."
            ],
            hasGallery: true,
            mockup: "",
            myWork: "",
        ...
        },
        {
            ...
            about: [
                ...
                <br />,
                "Die folgenden Bilder zeigen das entstandene Projekt und eine grobe grafische Darstellung der Softwarestuktur."
            ],
            hasGallery: true,
            mockup: "",
            myWork: "",
        ...
        },
        {
            ...
            about: [
                "In dem Projekt BuildAR habe ich meine Kompetenzen in Usertests und Augmented Reality entwickelt. Wir haben uns die Frage gestellt, welche Alternativen es zur etablierten Papieranleitung gibt und inwiefern diese Alternativen im Bereich User Experience mithalten einer Papieranleitung mithalten können.", 
                "Im Laufe des Projektes haben wir zwei größere Usertests durchgeführt und drei Prototypen erstellt. Wobei der erste Usertest verschiedene Darstellungsmöglichkeiten in AR verglichen hat und der zweite die Usability der einzelnen Prototypen.",
                "Als Kontroll-Anleitung haben wir eine Papieranleitung erstellt, als Alternativen eine XD Anleitung, die ein simple Webanleitung symbolisieren sollte, und eine Anleitung, die mithilfe von Augmented Reality dem User den nächsten Schritt angezeigt.",
                <br/>,
        ...
        },
        {
            ...
            about: [
                ...
                <br />,
                "Die folgenden Bilder zeigen einen gleinen Einblick in die Konzeption des Projektes, für einen tieferen Einblick empfehlt sich aber die Dokumentation."
            ],
            hasGallery: true,
            mockup: "",
            myWork: [
        ...
        },
        {
            ...
            about: [
                ...
                <br />,
                "Die folgenden Bilder zeigen den Prototyp aus dem ersten Semester, während im Video das Ergebnis aus dem Zweiten zu sehen ist:"
            ],
            hasGallery: true,
        ...
        },
        {
            ...
            about: [
                ...
                "Wir haben uns das Thema Fantasy League herausgesucht, in denen man individuelle Mannschaften erstellen und gegen andere Mannschaften antreten kann.",
                ...
                <br />,
                "Die folgenden Bilder zeigen die im Projekt entstandenen Diagramme:"
            ],
            hasGallery: true,
            mockup: "",
            myWork: "",
        ...
        },
        {
            ...
            about: [
                ...
                <br />,
                "Die folgenden Bilder zeigen ein Einblick in die Konzeption und Umsetzung, wahrend das Video ein Einblick in die Funktionsweisen des entstandenen Prototyps gibt."
            ],
            hasGallery: true,
        ...
        },
        {
            ...
            about: [
                "Dieses Projekt ist in meinem zweiten Semester an der Hochschule entstanden und in Java programmiert. Es ist eine Webanwendung des Spiels Risiko, in dem es darum geht die Welt mit den eigenen Einheiten zu erobern. Wobei der Spieler die Einheiten sinnvoll platzieren muss, um nicht die eigenen Länder zu verlieren."
            ],
            hasGallery: true,
            mockup: "",
            myWork: [
